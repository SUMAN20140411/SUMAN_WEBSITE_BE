...
export interface ApiCeoPageCeoPage extends Struct.SingleTypeSchema {
  collectionName: 'ceo_pages';
  info: {
    displayName: 'CeoPage';
    pluralName: 'ceo-pages';
    singularName: 'ceo-page';
  };
  options: {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    signatures: Schema.Attribute.Component<'shared.signature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCertificationPageCertificationPage
  extends Struct.SingleTypeSchema {
  collectionName: 'certification_pages';
  info: {
    displayName: 'CertificationPage';
    pluralName: 'certification-pages';
    singularName: 'certification-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::certification-page.certification-page'
    >;
    pageInfo: Schema.Attribute.Component<'shared.page-info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'certification-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCiPageCiPage extends Struct.SingleTypeSchema {
  collectionName: 'ci_pages';
  info: {
    displayName: 'CiPage';
    pluralName: 'ci-pages';
    singularName: 'ci-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    colors: Schema.Attribute.Component<'ci-page.colors', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'ci-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section2: Schema.Attribute.Component<'ci-page.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHistoryPageHistoryPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'history-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section2: Schema.Attribute.Component<'history-page.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section2: Schema.Attribute.Component<'homepage.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section3: Schema.Attribute.Component<'homepage.section3', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section4: Schema.Attribute.Component<'homepage.section4', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLocationPageLocationPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'location-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrganizationPageOrganizationPage
  ...
  attributes: {
    ...
    >;
    orgChart: Schema.Attribute.Component<'organization-page.org-chart', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProductPageProductPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'product-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRndPageRndPage extends Struct.SingleTypeSchema {
  collectionName: 'rnd_pages';
  info: {
    displayName: 'RndPage';
    pluralName: 'rnd-pages';
    singularName: 'rnd-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rnd-page.rnd-page'
    >;
    pageInfo: Schema.Attribute.Component<'shared.page-info', false>;
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'rnd-page.section1', false>;
    section2: Schema.Attribute.Component<'rnd-page.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVisionPageVisionPage extends Struct.SingleTypeSchema {
  collectionName: 'vision_pages';
  info: {
    displayName: 'VisionPage';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section1: Schema.Attribute.Component<'vision-page.section1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section2: Schema.Attribute.Component<'vision-page.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section3: Schema.Attribute.Component<'vision-page.section2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section4: Schema.Attribute.Component<'vision-page.section4', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ceo-page.ceo-page': ApiCeoPageCeoPage;
